...
public class ConfigRepository {
	...
	public enum ConfigName {
		 ...
		 * 저장소 레퍼런스 속성명
		 */
		STORAGE_REFS("storage.refs"), STORAGE_GRAPH("storage.graph"), STORAGE_OBJECTS("storage.objects"), STORAGE_INDEX("storage.index"), POSTGRES_VERSION("postgres.version"), ROCKSDB_VERSION("rocksdb.version"), FILE_VERSION("file.version");
