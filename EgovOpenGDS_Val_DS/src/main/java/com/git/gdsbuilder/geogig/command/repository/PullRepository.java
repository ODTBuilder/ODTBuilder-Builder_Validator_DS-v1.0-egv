...
public class PullRepository {
	...
	/**
	 * Remote Repository로 등록된 Geogig Repository의 추가, 삭제, 수정의 변동사항들을 현재 Checkout
	 * 상태인 Repository의 Branch에 병합함.
	 * <p>
	 ...
	 * @param remoteName
	 *            Remote Geogig Repository명
	 * @param branchName
	 *            Geogig Repository의 Branch명
	 * @param remoteBranchName
	 *            Remote Geogig Repository의 Branch명
	 * @param authorName
	 *            사용자명
	 * @param authorEmail
	 *            사용자 Email 주소
