...
public class RevertFeature {
	 ...
	 */
	private static final String param_oldCommitId = "oldCommitId="; // revert
																	// commit id
	/**
	 * newCommitId parameter
	 */
	private static final String param_newCommitId = "newCommitId="; // current
																	// commit id
	/**
	 * path parameter
	 */
	...
	/**
	 * 현재 Checkout한 Branch의 단일 피처에 대해 가장 최근의 Commit ID 버전을 이전 버전의 Commit ID로
	 * 되돌림.
	 * <p>
	 * Revert를 수행하면 두 Commit 버전이 병합되어 새로운 Commit ID가 생성됨.
	 * <p>
	 * 병합하는 과정에서 충돌이 발생할 수 있으며 충돌 해결 후 트랜젝션을 종료해야 Geogig Repository Database에
	 * 반영됨.
	 * 
	 * @param baseURL
