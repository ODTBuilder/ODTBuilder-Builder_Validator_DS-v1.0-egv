 ...
 */
package com.git.gdsbuilder.parse.file;
...
import com.git.gdsbuilder.parse.file.meta.FileMeta;
import com.git.gdsbuilder.parse.file.meta.FileMetaList;
import com.git.gdsbuilder.parse.file.shp.SHPFileLayerParser;
...
public class QAFileParser {
	...
	public File getGeoLayersPath() {
		return geoLayersPath;
	}

	public void setGeoLayersPath(File geoLayersPath) {
	 ...
	 *            파일 좌표계 ex) EPSG:4326
	 * @param cIdx
	 *            검수 종류 ID 수치지도 1.0 : 1, 수치지도 2.0 : 2, 지하시설물 1.0 : 3, 지하시설물 2.0
	 *            : 4, 임상도 : 5
	 * @param support
	 *            검수 종류 별 지원 파일 포맷
	 * @param unZipFile
	 ...
	 *            파일 좌표계 ex) EPSG:4326
	 * @param cIdx
	 *            검수 종류 ID (SHP 포맷의 검수 종류만 지원 가능) 수치지도 2.0 : 2, 지하시설물 2.0 : 4,
	 *            임상도 : 5
	 * @param geoLayersPath
	 *            Geoserver SHP Layer 파일
	 * @param fname
