...
public class DXFFileGeomParser {
	...
	/**
	 * 중심점, 반지름, 각도, 각도의 크기 값을 이용하여 {@link LineString} 타입의 Arc를
	 * {@link Geometry}로 반환.
	 * 
	 * @param epsg
	 *            좌표계 (ex EPSG:4326)
	 ...
	 *            좌표계 (ex EPSG:4326)
	 * @param startPt
	 *            {@link LineString}의 첫점
	 * @param endPt
	 *            {@link LineString}의 끝점
	 * @return {@link Geometry}
	 * @throws Exception
	 * 
	 * @author DY.Oh
	 ...
	 *            좌표계 (ex EPSG:4326)
	 * @param isClosed
	 *            LineString 폐합 여부 ({@code true} : 폐합, {@code false} : 미폐합)
	 *            <p>
	 *            {@code true}일 경우 {@link LineString}의 첫 점을 끝 점으로 한번 더 추가하여 폐합
	 *            시킴.
