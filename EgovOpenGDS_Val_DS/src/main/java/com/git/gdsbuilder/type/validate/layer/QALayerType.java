...
public class QALayerType {
	...
	/**
	 * {@link com.git.gdsbuilder.type.dt.collection.DTLayerCollection} 중
	 * layerID에 해당하는 {@link com.git.gdsbuilder.type.dt.layer.DTLayer} 반환
	 * 
	 * @param layerID
	 *            {@link com.git.gdsbuilder.type.dt.layer.DTLayer} layerID
	 * @param colleciton
