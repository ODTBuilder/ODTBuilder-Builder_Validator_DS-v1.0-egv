...
public class QALayerTypeList extends ArrayList<QALayerType> {
	 ...
	 * {@link com.git.gdsbuilder.type.dt.layer.DTLayer}를
	 ...
	 * 
	 * @param typeName
	 *            {@link com.git.gdsbuilder.type.validate.layer.QALayerType}
	 *            Name
	 * @param layerCollection
	 *            LayerID를 검색할
	 *            {@link com.git.gdsbuilder.type.dt.collection.DTLayerCollection}
	 * @return DTLayerList
	 *         {@link com.git.gdsbuilder.type.validate.layer.QALayerType}의
	 *         LayerID List와 동일한 ID를 가진
	 ...
	 *            Name
	 * @param layerID
	 *            {@link com.git.gdsbuilder.type.dt.layer.DTLayer} ID
	 * @param layerCollection
	 *            LayerID를 검색할
	 *            {@link com.git.gdsbuilder.type.dt.collection.DTLayerCollection}
	 * @return DTLayer
