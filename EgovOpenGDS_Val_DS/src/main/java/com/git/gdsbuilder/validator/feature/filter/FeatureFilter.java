...
public class FeatureFilter {
	...
	/**
	 * {@link SimpleFeature}의 Attribute 중 {@link AttributeFilter}에 해당하는 속성이
	 * 존재하는지 확인
	 * 
	 * @param sf
	 *            속성 필터 대상 {@link SimpleFeature}
	 * @param filters
	 *            속성 필터 OR 조건
	 ...
	 * @param filter
	 *            속성 필터 조건
	 * @return boolean 대상 {@link SimpleFeature}의 Attribute가
	 *         {@link AttributeFilter} 조건과 일치하면 {@code true}를 반환
	 * 
	 * @author DY.Oh
	 */
	 ...
	 *            {@link AttributeFilter} 조건 검사 대상 {@link DTLayerList}
	 * @param reTolerances
	 *            {@link AttributeFilter} 조건 검사 대상 여부를 확인. reTolerances에 저장되어 있는
	 *            {@link DTLayer}만 조건 검사를 수행함.
