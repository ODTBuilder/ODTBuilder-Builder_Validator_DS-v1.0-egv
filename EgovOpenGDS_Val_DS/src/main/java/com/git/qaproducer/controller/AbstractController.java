...
public class AbstractController {
	 ...
	 *            : 저장할 객체
	 */
	public void setSession(HttpServletRequest request, String sessionName, Object object) {
	 ...
	 * @param sessionName
	 */
	public void updateSession(HttpServletRequest request, String sessionName, Object object) {
		HttpSession httpSession = request.getSession();
		httpSession.setAttribute(sessionName, object);
	}
	 ...
	 * @param request
	 * @return int 200 : 성공 600 : 로그인세션 없음 601 : 미입력 텍스트 존재 602 : 서버이름중복 603 :
	 *         Geoserver 세션없음 604 : Geoserver 정보오류
	 */
	 ...
	 * @param request
	 * @return int 200 : 성공 600 : 로그인세션 없음 603 : Geoserver 세션없음 605 : 서버이름존재 X
	 */
	 ...
	 */
	public DTGeoserverManager getGeoserverManagerToSession(HttpServletRequest request, User loginUser,
			String serverName) {
