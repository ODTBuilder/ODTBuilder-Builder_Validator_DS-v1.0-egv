...
public interface GeoserverService {
	 ...
	 *         : 로그인세션 없음 604 : Geoserver 정보오류 607 : workspace 또는 datastore 존재 X
	 *         608 : 파일구조 이상 609 : 레이어 중복 613 : 데이터 존재 -> 미발행레이어 615 : prj파일 없음
	 */
	 ...
	 * @param dtGeoManager
	 *            DTGeoserverManager Object
	 * @param workspace
	 *            Geoserver Workspace명
	 * @param datastore
	 *            Geoserver Datasource명
	 * @param layerName
	 *            저장하고 싶은 layer명
	 * @param epsg
	 *            좌표계
	 * @param uploadJsons
	 *            { "serverName" : "테스트서버", "workspace" : "작업공간", "datastore" :
	 *            "저장소", "epsg" : "4326", "ignorePublication" : "false",
	 *            "uploadJson" :
	 ...
	 * @return JSONObject {file1 : 200, file2 : 500....} 200 : 성공 500 : 발행실패 600
	 *         : 로그인세션 없음 604 : Geoserver 정보오류 607 : workspace 또는 datastore 존재 X
	 *         609 : 레이어 중복 610 : 발행실패 613 : 데이터 존재 -> 미발행레이어 614 : Geojson 오류
	 */
