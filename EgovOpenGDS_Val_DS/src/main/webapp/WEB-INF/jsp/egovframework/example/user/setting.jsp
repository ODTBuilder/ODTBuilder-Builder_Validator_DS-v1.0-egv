...
<jsp:include page="/WEB-INF/jsp/egovframework/example/common/libimport.jsp" />
<style>
input.radio {
	visibility: hidden;
	display: none;
...
// 				}
			...
			$("#save-def").click(function() {
				...
				prexhr.open("POST", "${pageContext.request.contextPath}/option/retrievePresetNameByNameAndUidx.ajax");
				prexhr.onload = function() {
					...
					if (flag) {
	 					...
	 					xhr.open("POST", "${pageContext.request.contextPath}/option/createpreset.ajax");
	 					xhr.onload = function() {
			...
			$("#update-def").click(function() {
				...
				var prexhr = new XMLHttpRequest();
				prexhr.open("POST", "${pageContext.request.contextPath}/option/retrievePresetNameByNameAndUidxAndPid.ajax");
				prexhr.onload = function() {
					console.log('DONE', prexhr.readyState); // readyState will be 4
					var flag = true;
					var obj = JSON.parse(prexhr.response);
					...
					if (flag) {
						...
						var xhr = new XMLHttpRequest();
						xhr.open("POST", "${pageContext.request.contextPath}/option/updatePreset.ajax");
						xhr.onload = function() {
							console.log('DONE', xhr.readyState); // readyState will be 4
							window.location = "${pageContext.request.contextPath}/settinglist.do";
						};
